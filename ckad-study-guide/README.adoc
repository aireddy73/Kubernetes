...
3. https://github.com/aireddy73/Kubernetes/tree/main/ckad-study-guide/ch03/ch03[Configuration]
4. https://github.com/aireddy73/Kubernetes/tree/main/ckad-study-guide/ch04/ch04[Multi-Container Pods]
